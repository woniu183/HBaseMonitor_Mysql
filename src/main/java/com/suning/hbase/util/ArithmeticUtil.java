...
public class ArithmeticUtil {
    ...
    public static double sub(double v1, String v2) {
      BigDecimal b1 = new BigDecimal(Double.toString(v1));
      BigDecimal b2 = new BigDecimal(v2);
      return b1.subtract(b2).doubleValue();
  }
    public static double sub(String v1, double v2) {
      String v2string = Double.toString(v2);
      BigDecimal b1 = new BigDecimal(v1);
      BigDecimal b2 = new BigDecimal(Double.toString(v2));
      if(v1.compareTo(v2string) >=0){
        return b1.subtract(b2).doubleValue();
      }else{
    ...
    public static double div(String v1, String v2) {
        return div(v1, v2, DEF_DIV_SCALE).doubleValue();
    }
  
    public static double div(double v1, String v2) {
      return div(v1, v2, DEF_DIV_SCALE).doubleValue();
  }
    ...
    public static BigDecimal div(double v1, String v2, int scale) {
      if (scale < 0) {
          throw new IllegalArgumentException(
                  "The scale must be a positive integer or zero");
      }
